 ...
 * @author Razer
 */
public class ListePlanningFrontController implements Initializable {
    ...
    public void refreshList()
    {
        ...
        for(Planning p : plan){
            try{
                ...
                loader.setLocation(getClass().getResource("PlaItemFront.fxml"));
                Parent root =loader.load();
                nodes.add(root);
                vList.getChildren().add(root);
                PlaItemFrontController itemPlaController = new PlaItemFrontController();
...
//         FXMLLoader loader = new FXMLLoader(getClass().getResource("FrontPlanningAdd.fxml"));
//                 Parent root = loader.load(); 
//        vList.getScene().setRoot(root);
        FXMain.instance.getFrontController().render("FrontPlanningAdd.fxml");
    }
